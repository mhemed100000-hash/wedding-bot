...
def update_resources(country, chat_id_for_territory=None):
    ...
    if chat_id_for_territory:
        ...
        gold_cap_val = t_bonus.get("حد_ذهب", GOLD_CAP)
    else:
        income_multiplier = 1
        gold_cap_val = GOLD_CAP
...
async def handle_callback(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if data == "my_country":
        ...
        await query.edit_message_text(
            ...
            f"{alliance_text}{territory_text}\n"
            f"━━━━━━━━━━━━━━━\n"
    ...
    if data.startswith("atk_"):
        ...
        # تطبيق النتائج
        if report["فائز"] == "المهاجم":
            attacker["ذهب"] = attacker.get("ذهب", 0) + report["غنائم"]
            defender["ذهب"] = max(0, defender.get("ذهب", 0) - report["غنائم"])
