...
UNITS = {
    ...
    # 🪖 قوات
    "جندي": {"قوة": 1, "سعر": 100, "نوع": "قوات"},
    "دبابة": {"قوة": 10, "سعر": 1000, "نوع": "قوات"},
    "مدرعة": {"قوة": 6, "سعر": 700, "نوع": "قوات"},

    # ✈️ طائرات
    "J-10": {"قوة": 35, "سعر": 12000, "نوع": "طائرات"},
    "J-20": {"قوة": 60, "سعر": 30000, "نوع": "طائرات"},

    # 🚀 صواريخ (×5)
    "Grad": {"قوة": 25, "سعر": 2500, "نوع": "صواريخ"},
    "Scud": {"قوة": 50, "سعر": 5000, "نوع": "صواريخ"},
    "Iskander": {"قوة": 125, "سعر": 25000, "نوع": "صواريخ"},
    "Tomahawk": {"قوة": 150, "سعر": 40000, "نوع": "صواريخ"},
    "ICBM": {"قوة": 500, "سعر": 250000, "نوع": "صواريخ"},

    # 🔥 مميزة
    "خيبر": {"قوة": 450, "سعر": 280000, "نوع": "صواريخ"},
    "Kinzhal": {"قوة": 550, "سعر": 350000, "نوع": "صواريخ"}
}
